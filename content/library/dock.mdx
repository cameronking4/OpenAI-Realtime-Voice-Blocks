...
This component is a multi-agent dock that allows you to switch between different voice agents. Click the button to start call and the audio bars will animate to your Vapi voice agent. This component is animated purely with React implementation.
...
Copy the following code to your component file for example **_dock-example.tsx_**.
...
Copy the following dock component in to your components folder **_dock.tsx_**.
