...
This component displays a card that reacts to Vapi voice during the call. The ring represents the audio volume levels and dynamically animate using framer-motion. Click the mic in the center to start and stop Vapi agent.
