---
title: ChatGPT Voice Animation
description: Voice animation inspired by ChatGPT.
date: 2024-12-20
published: true
---
...
This component is inspired by the animation of the ChatGPT voice agent. Click the circle to toggle the conversation. It nakes use of states based on the sequence of logs in the WebRTC session. The component animates based on "idle", "thinking", "responding", and "listening" states.
...
Copy the following code to your component file for example **_chatgpt.tsx_**.
...
<CodeBlockWrapper size="wrapper">
```tsx {1,6}
import ChatGPT from "@/components/openai-blocks/chatgpt";
